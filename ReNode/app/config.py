...
configValues = {
    "main": {
        "version": 5, #версия конфига. При добавлении новых атрибутов увеличить на 1
        "workdir": ".\\Graphs", #рабочая директория. в рабочей директории лежат папки компиляции и графов
