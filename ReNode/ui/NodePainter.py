...
def draw_plus_port(painter, rect, info):
    """
    Custom paint function for drawing a plus-shaped port.
    ...
    # Draw vertical line
    v_line_rect = QtCore.QRectF(rect.center().x() - 1, rect.top(), 2, rect.height())
    painter.drawRect(v_line_rect)

    # Draw horizontal line
    h_line_rect = QtCore.QRectF(rect.left(), rect.center().y() - 1, rect.width(), 2)
