...
class PropFilePathCustom(BaseProperty):
    """
    ...
    def __init__(self, parent=None):
        super(PropFilePathCustom, self).__init__(parent)
        ...
        #self._ledit.setReadOnly(True)
        self._ledit.clearFocus()
        self._ledit.setPlaceholderText("Укажите путь...")
        ...
        self._title = "Выбрать файл" #Yodes: custom fileopen title
