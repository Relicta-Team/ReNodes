...
class ForEachExpressionArray(BinaryExpression):
    def __init__(self, action=None):
        super().__init__(Code, Keyword('forEach'), Array, None, action)


class ForEachExpressionHashMap(BinaryExpression):
    def __init__(self, action=None):
        super().__init__(Code, Keyword('forEach'), HashMap, None, action)
...
COMMON_EXPRESSIONS = [
    ...
    ForEachExpressionArray(),
    ForEachExpressionHashMap(),
    WhileExpression(),
    WhileDoExpression(),
