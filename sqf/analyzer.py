...
from sqf.types import Statement, Code, Nothing, Variable, Array, HashMap, String, Type, File, BaseType, Namespace, \
...
from sqf.common_expressions import COMMON_EXPRESSIONS, ForEachExpressionArray, ForEachExpressionHashMap, ElseExpression
    ...
    def execute_single(self, statement):
        ...
        if case_found:
            ...
            if case_found.is_match(values):
                ...
                if isinstance(case_found, (ForEachExpressionArray, ForEachExpressionHashMap, ElseExpression)):
                    outcome = Anything()
